...
response = requests.post(url=exersice_endpoint, headers=nutritionix_headers, json=parameters)
...
sheety_headers = {
    "Authorization": "very1secret2token3@meow"
}
...
for exercise in response.json()["exercises"]:
    ...
    add_row = requests.post(url=sheety_endpoint, headers=sheety_headers, json=sheety_row)
